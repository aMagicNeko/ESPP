...
inline float256_t get_x(const PoolBase* pool, bool direction) {
    return (direction ? pool->get_reserve0() : pool->get_reserve1()).convert_to<float256_t>();
}

inline float256_t get_y(const PoolBase* pool, bool direction) {
    return (direction ? pool->get_reserve1() : pool->get_reserve0()).convert_to<float256_t>();
}

inline float256_t get_k(const PoolBase* pool, bool direction) {
