...
class Tenderly {
    ...
    async verify(...contracts) {
        ...
        const platformID = verificationType === constants_2.VERIFICATION_TYPES.FORK
    ...
    async verifyMultiCompilerAPI(request) {
        ...
        switch (this._getVerificationType()) {
            case constants_2.VERIFICATION_TYPES.FORK:
                ...
                break;
            case constants_2.VERIFICATION_TYPES.DEVNET:
    ...
    _getVerificationType() {
        if ((0, util_1.isTenderlyNetworkConfig)(this.env.network.config)) {
            return this.tenderlyNetwork.devnetID !== undefined
                ? constants_2.VERIFICATION_TYPES.DEVNET
                : constants_2.VERIFICATION_TYPES.FORK;
        }
        const priv = this.env.config.tenderly?.privateVerification;
        if (priv !== undefined &&
            priv &&
            !(0, util_1.isTenderlyNetworkConfig)(this.env.network.config)) {
    ...
    _isVerificationOnPlatform(verificationType) {
        return (verificationType === constants_2.VERIFICATION_TYPES.DEVNET ||
            verificationType === constants_2.VERIFICATION_TYPES.FORK);
    }
